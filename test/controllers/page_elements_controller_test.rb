...
class PageElementsControllerTest < ActionController::TestCase
  ...
  test "should create page_element" do
    assert_difference('PageElement.count') do
      post :create, page_element: { active: @page_element.active, content: @page_element.content, name: @page_element.name, site_id: @page_element.site_id, type: @page_element.type }
    end
  ...
  test "should update page_element" do
    patch :update, id: @page_element, page_element: { active: @page_element.active, content: @page_element.content, name: @page_element.name, site_id: @page_element.site_id, type: @page_element.type }
    assert_redirected_to page_element_path(assigns(:page_element))
  end
